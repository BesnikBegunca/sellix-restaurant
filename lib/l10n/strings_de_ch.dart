...
/// Swiss German overrides. Only entries that differ from standard German are
/// listed; everything else falls through to kDe. Swiss written German has
/// no eszett.
const Map<String, String> kDeChOverrides = {
  'anulo': 'Abbräche',
  ...
  'kodiPin': 'PIN-Code',
  'kthehu': 'Zrugg',
  'kuponiUDerguaPrinter': 'D Quittig isch a de Drucker gschickt worde.',
  'mbyll': 'Schlüsse',
  ...
  'paPageCaktuar': 'Kein Lohn festgleit',
  'pagaMesatare': 'Durchschnittslohn',
  'pamjaErretEshteAktive': 'S dunkle Design isch aktiv.',
  'passwordMin8Characters': 'Passwort (mind. 8 Zeiche)',
  'provoPerseri': 'Nomol probiere',
  'receiptFooterText': 'Fusszeiletext vo de Quittig',
  'rregull': 'In Ornig',
  'rrogaDite': 'Lohn (€/Tag)',
  'rroge': 'Lohn',
