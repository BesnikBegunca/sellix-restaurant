// GENERATED-SOURCE: Albanian is the source language for the app's UI text.
// Keys are stable; edit wording here and mirror it in the other tables.

/// Albanian UI strings (source language, always complete).
const Map<String, String> kSq = {
  'admin': 'Admin',
  'adminPin': 'Admin PIN',
  'aktivitetiFundit': 'Aktiviteti i Fundit',
  'aktivizojeniPerseriCelesRi': 'Aktivizojeni përsëri me një çelës të ri.',
  'aktoreUnike': 'Aktorë unikë',
  'aktoriShumeVeprime': 'Aktori me të shumë veprime',
  'anulo': 'Anulo',
  'apiNukEshteKonfiguruar': 'API nuk është konfiguruar',
  'ardhura': 'Të Ardhura',
  'ardhura2': 'Të ardhura',
  'ardhuraBruto': 'Të ardhura bruto',
  'ardhuraNeto': 'Të ardhura neto',
  'ardhuraSipasKategorise': 'Të Ardhura sipas Kategorisë',
  'ardhuraSot': 'Të ardhura sot',
  'ardhuratDitoreJoPorositeHapura': 'Të ardhurat ditore, jo porositë e hapura.',
  'ardhuratSipasKategorise': 'Të ardhurat sipas kategorisë',
  'ardhuratTotale': 'Të Ardhurat Totale',
  'arsyejaOpsionale': 'Arsyeja (opsionale)',
  'artikujShitur': 'Artikuj të Shitur',
  'artikujShitur2': 'Artikuj të shitur',
  'artikujtPorosise': 'Artikujt e Porosisë',
  'asnjeShitjeRegjistruarEnde': 'Asnjë shitje e regjistruar ende.',
  'asnjeTavolineZene': 'Asnjë tavolinë e zënë',
  'asnjeTavolineZeneMomentin': 'Asnjë tavolinë e zënë për momentin.',
  'avanseGjithsej': 'Avanse Gjithsej',
  'backupPassword': 'Backup password',
  'bilanciHapur': 'Bilanci i hapur',
  'biznesTjeterUZbulua': 'Biznes tjetër u zbulua',
  'biznesi': 'Biznesi',
  'biznesiEshtePezulluarKontaktoniAdministratorin':
      'Biznesi është pezulluar. Kontaktoni administratorin.',
  'biznesiMeparshem': 'biznesi i mëparshëm',
  'biznesitTjeterLeximetNukFiltrohenEnde':
      'biznesit tjetër (leximet nuk filtrohen ende sipas tenant-it).',
  'brutoLarte': 'Bruto Më i Lartë',
  'burimi': 'Burimi',
  ...
  'celesiAktivizimit': 'Çelësi i Aktivizimit',
  'celesiAktivizimitOseKodiDegesEshte':
      'Çelësi i aktivizimit ose kodi i degës është i pasaktë.',
  'celesiAktivizimitOseKodiDegesNuk':
      'Çelësi i aktivizimit ose kodi i degës nuk u gjet.',
  'celesiEshteGati': 'Çelësi është gati',
  'celesiLicencesEshtePavlefshemOseKa':
      'Çelësi i licencës është i pavlefshëm ose ka skaduar.',
  'celesiUVerifikua': 'Çelësi u verifikua',
  'cilesime': 'Cilësime',
  'cilesimet': 'Cilësimet',
  'cilesimetFaturesURuajten': 'Cilësimet e faturës u ruajtën.',
  'cilesimetKompanise': 'Cilësimet e kompanisë',
  'close': 'Close',
  ...
  'czgjidhGjitha': 'Çzgjidh të Gjitha',
  ...
  'dhenaBiznesTjeterSqlite': 'Të dhëna nga biznes tjetër në SQLite',
  ...
  'dite': 'Ditë',
  'ditePunuara': 'Ditë të punuara',
  'diteTUShtuar': 'Ditë për t’u shtuar',
  'emriBiznesitDitetLicencesJaneDetyrueshme':
      'Emri i biznesit dhe ditët e licencës janë të detyrueshme.',
  'emriKategoriseRe': 'Emri i kategorisë së re',
  'emriKompaniseEshteDetyrueshem': 'Emri i kompanisë është i detyrueshëm.',
  'emriPinJaneDetyrueshemRrogaEshte':
      'Emri dhe PIN-i janë të detyrueshëm; rroga është opsionale.',
  'emriPlote': 'Emri i plotë',
  'emriShfaqetFatureDashboard': 'Emri që shfaqet në faturë dhe në dashboard.',
  'encryptedCompressedEncZip': 'Encrypted + Compressed (.enc.zip)',
  'encryptedEncDb': 'Encrypted (.enc.db)',
  'enterAdminPin': 'Enter admin PIN',
  'eventeGjithsej': 'Evente Gjithsej',
  'eventePagesash': 'Evente Pagesash',
  'eventeSigurie': 'Evente Sigurie',
  'fatura': 'Fatura',
  'faturaRimbursime': 'Fatura dhe rimbursime',
  'filtratKerkim': 'Filtrat & Kërkim',
  'filtroSipasKategorise': 'Filtro sipas Kategorisë',
  'fitimDitor': 'Fitim Ditor',
  'fitimJavor': 'Fitim Javor',
  'fitimJavor2': 'Fitim javor',
  'fitimKjoJave': 'Fitim kjo javë',
  'fitimMujor': 'Fitim Mujor',
  'fitimSot': 'Fitim sot',
  'fitime': 'Fitime',
  'fitimi': 'Fitimi',
  ...
  'fotoParakonfighuruara': 'Foto të parakonfighuruara',
  'fshi': 'Fshi',
  'fshiAvancin': 'Fshi avancin',
  'fshiKategorine': 'Fshi kategorinë',
  'fshiKategorine2': 'Fshi kategorinë?',
  'fshiKetePrintim': 'Fshi këtë printim?',
  'fshiPorosine': 'Fshi porosinë',
  'fshiRreshtin': 'Fshi rreshtin',
  ...
  'gabimServerProvoniPerseriVone': 'Gabim në server. Provoni përsëri më vonë.',
  'gjendja': 'Gjendja',
  'gjendjaStafitTavolinaveMenuseKlikoHapur':
      'Gjendja e stafit, tavolinave dhe menusë — kliko për të hapur seksionin.',
  'gjendjaTurnit': 'Gjendja e turnit',
  'gjendjaUDerguaPrinter': 'Gjendja u dërgua në printer.',
  'gjeneruar': 'Gjeneruar në',
  'gjeresiaLetres': 'Gjerësia e letrës',
  'gjitha': 'Të gjitha',
  'gjithaFushatJaneDetyrueshme': 'Të gjitha fushat janë të detyrueshme.',
  'gjithaLira': 'Të gjitha të lira',
  'gjithaTavolinat': 'Të gjitha tavolinat',
  'gjithaTransaksionet': 'Të gjitha transaksionet',
  'gjithaVeprimet': 'Të gjitha veprimet',
  'gjithckaNdikonStafiPrinteriFaturatNdare':
      'Gjithçka që ndikon te stafi, printeri dhe faturat — e ndarë sipas kartave.',
  'gjitheAktoret': 'Të gjithë aktorët',
  'gjitheKamarieret': 'Të gjithë kamarierët',
  'gjuhaEkraneveMenaxheritStafit': 'Gjuha e ekraneve të menaxherit dhe stafit.',
  'gjurmoGjithaAktivitetetSistemit': 'Gjurmo të gjitha aktivitetet e sistemit',
  'hapGjitha': 'Hap të gjitha',
  'hapOseMbyllTurnin': 'Hap ose mbyll turnin',
  'hapShtypOseMbyllTurneOperative': 'Hap, shtyp ose mbyll turne operative.',
  'hapSirtarinParave': 'Hap sirtarin e parave',
  'hapeTurninShitur': 'Hape turnin për të shitur',
  'hapjaDeriMbylljenGjendjes': '(nga hapja deri në mbylljen e gjendjes).',
  'hen': 'Hën',
  'hene': 'E hënë',
  'historikuAuditAuditLogsRuhetGjithmone':
      'Historiku audit (audit_logs) ruhet gjithmonë. ',
  'historikuShitjeve': 'Historiku i shitjeve',
  'instaluesiWindowsMundKopjojeAppConfig':
      'Instaluesi Windows mund të kopjojë app_config.json nga release\\\\ ',
  'jave': 'Javë',
  'joKopjoniAppConfigJsonKetu': 'jo — kopjoni app_config.json këtu',
  'joPrintimetTjeraNjejtesTavoline':
      'jo printimet e tjera të së njëjtës tavolinë.',
  'juFaleminderit': 'Ju Faleminderit!',
  'juLutemVendosniCelesinAktivizimit':
      'Ju lutem vendosni çelësin e aktivizimit.',
  'juLutemVendosniKodinDeges': 'Ju lutem vendosni kodin e degës.',
  'k1KrijoniSkedarinAppConfigJson':
      '1. Krijoni skedarin app_config.json në të njëjtin folder ',
  'k1TavolinePorosiHapur': '1 tavolinë/porosi të hapur',
  'k1TavolinePorosiHapurNukU':
      '1 tavolinë me porosi të hapur nuk u fshi (fatura e ruajtur).',
  'k1Zene': '1 e zënë',
  'k355691234567': '+355 69 123 4567',
  'k7DitetFundit': '7 ditët e fundit',
  ...
  'kamariereRegjistruar': 'Kamarierë të regjistruar',
  'kamarieret': 'Kamarierët',
  'kamarieriShitjetLarta': 'Kamarieri me shitjet më të larta.',
  'keniTavolinaHapura': 'Keni tavolina të hapura',
  ...
  'kerkesaNukULejuaKontaktoniAdministratorin':
      'Kërkesa nuk u lejua. Kontaktoni administratorin.',
  'kerkesaTransferimUDerguaSuperadmin':
      'Kërkesa për transferim u dërgua te SuperAdmin. ',
  'kerkesaUAnulua': 'Kërkesa u anulua.',
  'kerkoIdShitjeje': 'Kërko me ID shitjeje',
  'kerkoPorosiArtikujOseKamariere': 'Kërko porosi, artikuj ose kamarierë...',
  'kerkohetAprovimSuperadmin': 'Kërkohet aprovim nga SuperAdmin',
  'kerkohetFjalekalim': 'Kërkohet fjalëkalim',
  'keteMuaj': 'Këtë Muaj',
  ...
  'kjoPajisjeEshteTashmeAktivizuarDege':
      'Kjo pajisje është tashmë e aktivizuar në një degë tjetër.',
  'klikoniPoshteZgjedhurEmrinTuaj': 'Klikoni poshtë për të zgjedhur emrin tuaj',
  'kodiDeges': 'Kodi i Degës',
  'kodiDeges2': 'Kodi i degës',
  'kodiPin': 'Kodi PIN',
  'konfigurimiPlanimetrise': 'Konfigurimi i Planimetrisë',
  'konfiguroMenaxherinPare': 'Konfiguro Menaxherin e Parë',
  'kontrolliDeshtoiProvoniSerish': 'Kontrolli dështoi. Provoni sërish.',
  'kosto': 'Kosto',
  'krijoArtikullRiMenunePosIt': 'Krijo një artikull të ri për menunë e POS-it.',
  'krijoBiznesTjeter': 'Krijo biznes tjetër',
  'kthehu': 'Kthehu',
  'kuponiUDerguaPrinter': 'Kuponi u dërgua në printer.',
  ...
  'kyPinEkzistonTashme': 'Ky PIN ekziston tashmë.',
  ...
  'lidhjaServerinDeshtoiCertifikatePavlefshme':
      'Lidhja me serverin dështoi (certifikatë e pavlefshme).',
  'lira': 'Të lira',
  'lire': 'E lirë',
  'lire2': 'Lirë',
  'llogariDrejtaMenaxheriDashboardGjendjeMenu':
      'Llogari me të drejta menaxheri: dashboard, gjendje, menu e më tej.',
  'llogaritesiKusurit': 'Llogaritësi i Kusurit',
  'lloji': 'Lloji',
  'marte': 'E martë',
  'maxRetriesPerdorniRetryManual': 'Max retries — përdorni Retry manual',
  'mbyll': 'Mbyll',
  'mbyllAplikacionin': 'Mbyll aplikacionin',
  'mbyllGjitha': 'Mbyll të gjitha',
  'mbyllenPorositeHapuraTavolinaNisShift':
      'mbyllen porositë e hapura në tavolina dhe nis shift i ri. ',
  'mbylljeGjendje': 'Mbyllje gjendje',
  'menaxheret': 'Menaxherët',
  'menaxhimiKamariereve': 'Menaxhimi i Kamarierëve',
  'menaxhimiTavolinave': 'Menaxhimi i Tavolinave',
  'menaxhoAnetaretStafitKodetHyrjes':
      'Menaxho anëtarët e stafit dhe kodet e hyrjes.',
  'menjehereHerenTjeter': 'menjëherë herën tjetër.',
  'menu': 'Menu',
  'menyraPageses': 'MËNYRA E PAGESËS',
  'mer': 'Mër',
  'merkure': 'E mërkurë',
  'mesatarjaPorosise': 'Mesatarja e porosisë',
  'mesazhiFund': 'Mesazhi në fund',
  'modalitetiErret': 'Modaliteti i errët',
  'modalitetiNdritshem': 'Modaliteti i ndritshëm',
  ...
  'ndrysho': 'Ndrysho',
  'ndryshoFiltratOsePeriudhen': 'Ndrysho filtrat ose periudhën.',
  'ndryshoKategorineOsePeriudhen': 'Ndrysho kategorinë ose periudhën.',
  'ndryshoMenune': 'Ndrysho menunë',
  'ndryshoPagenDitore': 'Ndrysho pagën ditore',
  'ndryshoPin': 'Ndrysho PIN-in',
  'ndryshoPinHapDashboardMenaxherit':
      'Ndrysho PIN-in që hap dashboard-in e menaxherit.',
  'nen': 'Nën',
  'nentor': 'Nëntor',
  'nentotali': 'Nëntotali  ',
  'neseKeMarreKeyRiVendose':
      'Nëse ke marrë një key të ri, vendose këtu për ta vazhduar licencën.',
  'ngarkoShume': 'Ngarko më shumë',
  ...
  'nukKaKamariereEnde': 'Nuk ka kamarierë ende',
  'nukKaKamariereRegjistruar': 'Nuk ka kamarierë të regjistruar.',
  ...
  'nukKaLidhjeServerinKontrolloniInternetin':
      'Nuk ka lidhje me serverin. Kontrolloni internetin dhe provoni përsëri.',
  'nukKaLidhjeServerinProvoniSerish':
      'Nuk ka lidhje me serverin. Provoni sërish.',
  'nukKaLinjaProdukteshRegjistruara':
      'Nuk ka linja produktesh të regjistruara.',
  'nukKaMbylljeGjendje': 'Nuk ka mbyllje gjendje',
  'nukKaMenaxhereEnde': 'Nuk ka menaxherë ende',
  'nukKaProdukteKeteKategori': 'Nuk ka produkte në këtë kategori.',
  'nukKaRreshtaEksportShtoOse':
      'Nuk ka rreshta për eksport — shto ose ndrysho filtrat.',
  'nukKaRreshtaPerputhenFiltrat': 'Nuk ka rreshta që përputhen me filtrat',
  'nukKaShitjeEndeKrahasuarStafin':
      'Nuk ka shitje ende për të krahasuar stafin.',
  'nukKaShitjeKetePeriudhe': 'Nuk ka shitje në këtë periudhë.',
  'nukKaShitjeRegjistruaraSesion': 'Nuk ka shitje të regjistruara në sesion.',
  'nukKaShitjeRegjistruaraShiftAs':
      'Nuk ka shitje të regjistruara për shift-in dhe as porosi të hapura në tavolina.',
  'nukKaShpenzimeRegjistruara': 'Nuk ka shpenzime të regjistruara.',
  'nukKaTavolinaKonfiguruara': 'Nuk ka tavolina të konfiguruara.',
  'nukKaVeprimeKetePeriudhe': 'Nuk ka veprime në këtë periudhë.',
  'nukMundKthehetMbrapsht': 'Nuk mund të kthehet mbrapsht.',
  'nukMundLidhemiServerinKontrolloniLidhjen':
      'Nuk mund të lidhemi me serverin. Kontrolloni lidhjen e internetit ',
  'nukProcesonWaitersPorosiKuzhineEtj':
      'nuk i proceson (waiters, porosi, kuzhinë, etj.). ',
  'nukUGjetAsnjeKamarier': 'Nuk u gjet asnjë kamarier',
  'nukUGjetAsnjePrinterWindows': 'Nuk u gjet asnjë printer Windows.',
  'nukUGjetenFotoAssetsImages': 'Nuk u gjetën foto në assets/images/.',
  'nukUGjetenRreshtaOutboxPambeshtetur':
      'Nuk u gjetën rreshta outbox të pambështetur.',
  'numriStafit': 'Numri i Stafit',
  'operacioniEshteAktiv': 'Operacioni është aktiv',
  'oraNgarkuar': 'Ora më e ngarkuar',
  'oseVendosniVariablinMjedisitPosApi':
      'Ose vendosni variablin e mjedisit POS_API_BASE_URL me të njëjtin URL, ',
  'pShMainPaneliAdmin': 'p.sh. MAIN (nga paneli admin)',
  'pShPosXxxxXxxxXxxx': 'p.sh. POS-XXXX-XXXX-XXXX',
  'paFoto': 'Pa foto',
  'paPageCaktuar': 'Pa pagë të caktuar',
  'paShiftAktivDb': 'Pa shift aktiv në DB',
  'pagaMesatare': 'Paga Mesatare',
  'pagesaGjithsej': 'Pagesa Gjithsej',
  'pagesaNeto': 'Pagesa Neto',
  'pagese': 'Pagesë',
  'pagoiKlienti': 'Pagoi Klienti',
  'pajisjaEshtePezulluarKontaktoniAdministratorin':
      'Pajisja është pezulluar. Kontaktoni administratorin.',
  'pajisjaUCaktivizua': 'Pajisja u çaktivizua',
  'pamjaErretEshteAktive': 'Pamja e errët është aktive.',
  'pamjaOperative': 'Pamja operative',
  'paraPastroshDhenatLokale': 'para se të pastrosh të dhënat lokale.',
  ...
  'pasPagesesSuksesshme': 'Pas pagesës së suksesshme.',
  'pasShpenzimeve': 'Pas shpenzimeve',
  'password': 'Password',
  'passwordMin8Characters': 'Password (min 8 characters)',
  'passwordPasakte': 'Password i pasaktë.',
  'pastrimDetyrueshemNdryshimBiznesiRelease':
      'Pastrim i detyrueshëm në ndryshim biznesi (release)',
  'pastrimLokalDetyrueshemParaVazhdimit':
      'pastrim lokal të detyrueshëm para vazhdimit.',
  'pastrimOpsionalDebug': 'Pastrim opsional në debug',
  ...
  'permbledhjaMujore': 'Përmbledhja Mujore',
  'permbledhjaSotme': 'Përmbledhja e sotme',
  'permbledhje': 'Përmbledhje',
  'permbledhjeDites': 'Përmbledhje e ditës',
  'permbledhjeSipasLlojit': 'Përmbledhje sipas llojit',
  'pershkrimi': 'PËRSHKRIMI',
  'pershkrimi2': 'Përshkrimi',
  'pinAktualEshteGabuar': 'PIN-i aktual është i gabuar.',
  'pinDuhetJeteUnikMinimum4': 'PIN-i duhet të jetë unik dhe minimum 4 shifra.',
  'pinMinimum4ShifraVetemNumra':
      'PIN: minimum 4 shifra, vetëm numra (gjatësia e lirë).',
  'pinMode': 'PIN Mode',
  'pinPerdorTani': 'PIN-i që përdor tani',
  'pinRiKonfirmimiNukPerputhen': 'PIN-i i ri dhe konfirmimi nuk përputhen.',
  'pinRiMinimum4ShifraVetem': 'PIN-i i ri: minimum 4 shifra, vetëm numra.',
  'plotesoInformacioninPersonalizoFoton':
      'Plotëso informacionin dhe personalizo foton.',
  'porosi': 'Porosi',
  'porosiFshireMenaxheri': 'Porosi e fshirë nga menaxheri',
  ...
  'produkteCmime': 'Produkte dhe çmime',
  'provoPerseri': 'Provo përsëri',
  'punetori': 'PUNËTORI',
  'punetoriMire': 'Punëtori më i mirë',
  ...
  'rrogaDite': 'Rroga (€/ditë)',
  'rroge': 'Rrogë',
  'rrugaShembullNr1Tirane': 'Rruga Shembull Nr. 1, Tiranë',
  'ruajEmrin': 'Ruaj emrin',
  'ruajFaturen': 'Ruaj faturën',
  'ruajPlanimetrine': 'Ruaj Planimetrinë',
  'ruajVetemTestim': 'Ruaj vetëm për testim',
  'searchTransactions': 'Search transactions...',
  'serveriKtheuPergjigjeBoshProvoniPerseri':
      'Serveri ktheu përgjigje bosh. Provoni përsëri.',
  'serveriNukKtheuBusinessidProvoniPerseri':
      'Serveri nuk ktheu businessId. Provoni përsëri.',
  'serveriNukKtheuRefreshTokenAktivizimi':
      'Serveri nuk ktheu refresh token — aktivizimi nuk mund të ruhet.',
  'shenimOpsional': 'Shënim (opsional)',
  'shfaqenKetuDatenOren': 'shfaqen këtu me datën dhe orën.',
  ...
  'shikoUdhezimet': 'Shiko udhëzimet',
  'shitjaURuajtPorPrintimiDeshtoi': 'Shitja u ruajt, por printimi dështoi. ',
  'shitje': 'Shitje',
  ...
  'shkoPunaDuhetTani': 'Shko te puna që të duhet tani.',
  'shkruajPinSakteStafitDoRuhet':
      'Shkruaj PIN-in e saktë të stafit. Do të ruhet që ta shohësh ',
  'shpenzime': 'Shpenzime',
  'shpenzimeGjithsej': 'Shpenzime Gjithsej',
  'shpenzimeRrogaDeri25Rreshta': 'Shpenzime / rroga (deri në 25 rreshta)',
  'shpenzimeTotaleRegjister': 'Shpenzime totale (regjistër)',
  'shpenzimetSotme': 'Shpenzimet e Sotme',
  'shtoKamarierRi': 'Shto Kamarier të Ri',
  'shtoMenaxherRi': 'Shto Menaxher të Ri',
  'shtoMenaxherinPareFormularinSiper':
      'Shto menaxherin e parë me formularin më sipër.',
  'shtoPijeRe': 'Shto pije të re',
  'shtoPijenMenu': 'Shto pijen në menu',
  'shtoShpenzim': 'Shto shpenzim',
  'shtoShpenzimRroge': 'Shto shpenzim / rrogë',
  ...
  'siguriaMenaxherit': 'Siguria e menaxherit',
  'sistemShpejteThjeshteMenaxhimRestoranti':
      'Sistem i shpejtë dhe i thjeshtë për menaxhim restoranti',
  'skedariEkziston': 'Skedari ekziston',
  'skedariPritur': 'Skedari i pritur',
  'stafAktiv': 'Staf aktiv',
  'stafRegjistruar': 'Staf i regjistruar',
  'statistikatShitjeveSipasPunonjesve':
  ...
  'tavolina': 'Tavolina',
  'tavolinaGjithsej': 'Tavolina Gjithsej',
  'tavolinaLira': 'Tavolina të Lira',
  'tavolinaRresht': 'Tavolina për rresht',
  'tavolinaZena': 'Tavolina të zëna',
  'tavolinat': 'Tavolinat',
  'tavolinatTani': 'Tavolinat tani',
  'tekstiPrintohetFundFatures': 'Teksti që printohet në fund të faturës.',
  'topKamarier': 'Top kamarier',
  'totaliGjitha': 'Totali (të gjitha)',
  'totaliGjithaTavolinave': 'Totali i të gjitha tavolinave',
  'totaliShpenzimeve': 'Totali i shpenzimeve',
  'transaksione': 'Transaksione',
  'turni': 'Turni',
  ...
  'veprimeShpejta': 'Veprime të shpejta',
  'verifikoCelesin': 'Verifiko çelësin',
  ...
  'zene': 'E zënë',
  'zene2': 'Zënë',
  'zgjidhEmrinTend': '👤 Zgjidh Emrin Tënd',
  'zgjidhGjitha': 'Zgjidh të Gjitha',
  'zgjidhKamarier': 'Zgjidh një kamarier.',
  ...
  'localhostNotAllowed':
      'Ky version nuk mund të përdorë localhost. Vendosni app_config.json pranë aplikacionit ose konfiguroni POS_API_BASE_URL.',
  'clearUnsupportedOutboxExplainer':
      'Fshin nga outbox vetëm ngjarjet me entityType që pos_api nuk i proceson (waiters, porosi, kuzhinë, etj.). Shitjet dhe entitetet e sync-uara nuk preken.',
  'configStep1':
  ...
  'kategoria': 'KATEGORIA',
  'shumaHeader': 'SHUMA',
  'developerDashboard': 'Paneli i zhvilluesit',
  'manageLocalBusinesses': 'Menaxho bizneset dhe licencat lokale',
  'selectBusiness': 'Zgjidh biznesin',
  'createBusiness': 'Krijo biznes',
  'createAndIssueKey': 'Krijo dhe gjenero key',
  'businessName': 'Emri i biznesit',
  'telefoni': 'Telefoni',
  'adresa': 'Adresa',
  'kopjo': 'Kopjo',
  'licenceKeyReady': 'Çelësi i licencës është gati',
  'copyKeyHint': 'Kopjojeni dhe dërgojeni klientit. Nuk ruhet përsëri.',
  'keyCopied': 'Çelësi u kopjua.',
  'expiresAtLabel': 'Skadon',
  'noBusinessesYet': 'Nuk ka biznese lokale ende',
  'noBusinessesYetHint': 'Krijo të parin me formularin në të djathtë.',
  'licenceDays': 'Ditë licence',
  'existingBusinesses': 'Bizneset ekzistuese',
  'newBusiness': 'Biznes i ri',
  'licenceValidDays': 'Sa ditë të zgjasë licenca.',
  'branchCodeHint': 'Kodi i degës, p.sh. MAIN.',
  'active': 'Aktive',
  'expired': 'Skaduar',
};
