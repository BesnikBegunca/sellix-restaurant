...
const Map<String, String> kEn = {
  ...
  'manageLocalBusinesses': 'Manage local businesses and licences',
  'selectBusiness': 'Select business',
  'createBusiness': 'Create business',
  'createAndIssueKey': 'Create and issue key',
  'businessName': 'Business name',
  'telefoni': 'Phone',
  'adresa': 'Address',
  'kopjo': 'Copy',
  'licenceKeyReady': 'Licence key ready',
  'copyKeyHint': 'Copy it and send it to the client. It is not shown again.',
  'keyCopied': 'Key copied.',
  'expiresAtLabel': 'Expires',
  'noBusinessesYet': 'No local businesses yet',
  'noBusinessesYetHint': 'Create the first one with the form on the right.',
  'licenceDays': 'Licence days',
  'existingBusinesses': 'Existing businesses',
  'newBusiness': 'New business',
  'licenceValidDays': 'How many days the licence lasts.',
  'branchCodeHint': 'The branch code, e.g. MAIN.',
  'active': 'Active',
  'expired': 'Expired',
};
