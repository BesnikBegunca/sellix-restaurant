      ...
      children: [
        ...
        Row(
          children: [
            ...
            FilledButton(
              onPressed: () {
                final pr = double.tryParse(_prodPrice.text) ?? 0;
                final id = _selectedCatId ?? catValue;
                if (_prodName.text.trim().isNotEmpty && pr > 0) {
                  m.addProduct(
                    categoryId: id,
                    name: _prodName.text,
                    price: pr,
            ...
            title: Row(
              children: [
                ...
                IconButton(
                  ...
                  icon: const Icon(Icons.delete_outline),
                  color: AppColors.negativeText,
                  onPressed: () => m.removeCategory(c.id),
                ),
              ],
            ),
            subtitle: Text('${c.products.length} produkte'),
            children: [
