...
class DefaultMenuCatalog {
  ...
  static const List<DefaultProductDef> products = [
    ...
    DefaultProductDef(
      id: '${kIdPrefix}prod_makiato_vogel',
      name: 'Makiato e Vogel',
      categoryId: '${kIdPrefix}cat_kafe',
      price: 1.00,
      emoji: '☕',
      imagePath: 'assets/images/machiato.png',
    ...
    DefaultProductDef(
      id: '${kIdPrefix}prod_grey_goose_vodka',
      name: 'Vodka Grey Goose',
      categoryId: '${kIdPrefix}cat_alkool',
      price: 5.00,
      emoji: '🍾',
      imagePath: 'assets/images/grey-goose-vodka-1-liter.png',
    ),
    DefaultProductDef(
      id: '${kIdPrefix}prod_gin_bombay',
      name: 'Gin Bombay',
      categoryId: '${kIdPrefix}cat_alkool',
      price: 5.00,
      emoji: '🍾',
      imagePath: 'assets/images/ginbombay.png',
    ),
    ...
    DefaultProductDef(
      id: '${kIdPrefix}prod_uje_natyral',
      name: 'Uje Natyral',
      categoryId: '${kIdPrefix}cat_kafe',
      price: 1.00,
      emoji: '💧',
      imagePath: 'assets/images/ujenatyral.png',
    ),
    DefaultProductDef(
      id: '${kIdPrefix}prod_uje_gazuar',
      name: 'Uje i Gazuar',
      categoryId: '${kIdPrefix}cat_kafe',
      price: 1.00,
      emoji: '💧',
      imagePath: 'assets/images/ujeigazuar.png',
    ),
  ];
}
